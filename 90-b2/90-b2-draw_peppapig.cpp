...
static void nose()
{
	...
	hdc_ellipse(base_x-20, base_y-335, 23, 38, 30, 1, 4, PCOLOR_NOSE_FILLED);//鼻子填充
...
static void head()
{
	...
	hdc_arc(base_x - 20, base_y - 70, 265, 0, 30, 72); //上部的边线
	hdc_arc(base_x + 55, base_y - 415, 132, 200, 221, 46);//下部的边线
...
static void ears()
{
	...
	hdc_ellipse(base_x+60, base_y-375, 16, 32, 15, 1, 5, PCOLOR_EARS_FILLED);	//耳朵内圈

	hdc_ellipse(base_x+110, base_y-358, 18, 35, 15, 0, 5, PCOLOR_EARS_LINE);//耳朵外圈
	hdc_ellipse(base_x+110, base_y-358, 16, 32, 15, 1, 5, PCOLOR_EARS_FILLED);	//耳朵内圈
}
/***************************************************************************
  函数名称：
  功    能：
